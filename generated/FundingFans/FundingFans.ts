...
export class FundingFans__getCampaignDetailsResultValue0Struct extends ethereum.Tuple {
  get artist(): Address {
...
export class FundingFans__getCampaignDonorsResultValue0Struct extends ethereum.Tuple {
  get donor(): Address {
    return this[0].toAddress();
  }
...
export class FundingFans extends ethereum.SmartContract {
  static bind(address: Address): FundingFans {
    return new FundingFans("FundingFans", address);
  }
  ...
  getCampaignDetails(
    campaignId: Bytes
  ): FundingFans__getCampaignDetailsResultValue0Struct {
    let result = super.call(
      "getCampaignDetails",
    ...
    return changetype<FundingFans__getCampaignDetailsResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getCampaignDetails(
    campaignId: Bytes
  ): ethereum.CallResult<FundingFans__getCampaignDetailsResultValue0Struct> {
    let result = super.tryCall(
      "getCampaignDetails",
      "getCampaignDetails(bytes32):((address,string,string,string,string,string,string,string,string,uint256,uint256,uint256,int256,string))",
      [ethereum.Value.fromFixedBytes(campaignId)]
    ...
    return ethereum.CallResult.fromValue(
      changetype<FundingFans__getCampaignDetailsResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  getCampaignDonors(
    campaignId: Bytes
  ): Array<FundingFans__getCampaignDonorsResultValue0Struct> {
    let result = super.call(
      "getCampaignDonors",
    ...
    return result[0].toTupleArray<
      FundingFans__getCampaignDonorsResultValue0Struct
    >();
  }
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<FundingFans__getCampaignDonorsResultValue0Struct>()
    );
  }
